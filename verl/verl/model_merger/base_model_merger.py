...
class BaseModelMerger(ABC):
    ...
    def get_transformers_auto_model_class(self):
        def _get_vision2seq_auto_model():
            """
            Resolve the correct AutoModel class for vision-text-to-text models across transformers versions.
            ...
            if version.parse(transformers.__version__) >= version.parse("4.54.0"):
                try:
                    ...
                    # Fallback in case a fork still exposes the old alias
                ...
                try:
                    ...
                    # Fallback if backported rename is present
                    from transformers import AutoModelForImageTextToText
        ...
        if has_remote_code:
            ...
            match auto_class:
                ...
                case "AutoModelForVision2Seq":
                    return _get_vision2seq_auto_model()
                case _:
