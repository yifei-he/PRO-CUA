...
MODEL_NAME=qwen3_8b
MAX_TASKS=256
FULL_NAME=${EXP_NAME}_${MODEL_NAME}_${MAX_TASKS}tasks_qwen3-8b-prm_all_steps_finished_traj_verl_${BASE_LR}
...
#######################################################
if [ "$round" -eq 1 ]; then
folder_path=${PRO_CUA_DATA_ROOT}/qwen3_WebVoyager_train_data_unique_ids_train/qwen3_8b_256_tasks_20steps_temperature0.7/round_1
...
python3 -m verl.trainer.main_ppo \
  ...
  reward.reward_model.model_path=Qwen/Qwen3-VL-8B-Instruct \
  reward.reward_model.rollout.name=vllm \
  reward.reward_model.rollout.max_model_len=12288 \
