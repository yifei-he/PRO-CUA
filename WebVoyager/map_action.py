...
# print(map_aguvis_action("pyautogui.write(message='san francisco')", 1,2))
# print(map_oai_action({
#                     "action": "click",
#                     "args": "{\"id\":\"3\",\"x\":300,\"y\":418,\"button\":1}"
#                 }))
# print(map_oai_action({'path': [{'x': 205, 'y': 438}, {'x': 556, 'y': 514}], 'type': 'drag'}))