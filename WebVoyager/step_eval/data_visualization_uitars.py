...
def process_folder_visualization(file_dir):
    ...
    for i, action in enumerate(trajectory):
        ...
        action_str = action['content'].split('Action: ')[-1].strip()
...
# main_folder = '/mnt/cache/users/t-yifeihe/cua/data/openwebvoyager_webvoyager_UI-TARS-1.5-7B_8rollout/20250708_21_17_46'
# main_folder = '/mnt/cache/users/t-yifeihe/cua/data/openwebvoyager_others_UI-TARS-1.5-7B_8rollout/20250712_02_26_14'
# subfolders = [f.path for f in os.scandir(main_folder) if f.is_dir()]
subfolders = ['/data/common/yifei/cua/data/qwen3_webvoyager_test_amzn/20260115_15_19_31/taskAmazon--0-1']
