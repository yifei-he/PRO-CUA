...
def auto_eval_by_gpt4v(process_dir, openai_client, api_model, img_num):
    ...
    if 'Action: ANSWER' not in ans_info and 'finished(content=' not in ans_info and 'terminate' not in ans_info and '"action": "answer"' not in ans_info:
    ...
    while True:
        ...
        try:
            ...
            openai_response = openai_client.chat.completions.create(
                model="Qwen/Qwen3-VL-8B-Instruct", messages=messages, max_tokens=1000, seed=42, temperature=0
            )
